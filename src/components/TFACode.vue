<template>
    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" class="box" label-width="80px">
        ...
        <el-form-item label="令牌序号" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.tokenNo" disabled></el-input>
        </el-form-item>
        <el-form-item label="公司名称" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.companyName" disabled></el-input>
        </el-form-item>
        <el-form-item label="创建时间" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.createTime" disabled></el-input>
        </el-form-item>
        <el-form-item label="过期时间" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.expireTime" disabled></el-input>
        </el-form-item>
        <el-form-item label="密码长度" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.passwordLength" disabled></el-input>
        </el-form-item>
        <el-form-item label="时间步进" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.timeStep" disabled></el-input>
        </el-form-item>
        <el-form-item label="令牌版本" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.version" disabled></el-input>
        </el-form-item>
        <el-form-item label="宁盾密钥" v-if="isTokenDetailVisible">
            <el-input v-model="tokenDetail.seed" show-password></el-input>
        </el-form-item>
        <el-form-item>
            <el-col :span="8">
                <el-button type="primary" @click="onResolve('ruleForm')">解析URL</el-button>
            </el-col>
            <el-col :span="8">
                <el-button type="danger" @click="resetForm('ruleForm')">重置</el-button>
            </el-col>
            <el-col :span="8">
                <el-button type="plain" @click="go2Code()">获取 Code</el-button>
            </el-col>
        </el-form-item>
    </el-form>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      fillData() {
        ...
        this.isTokenDetailVisible = true
      },
      ...
      resetForm(formName) {
        this.isTokenDetailVisible = false
